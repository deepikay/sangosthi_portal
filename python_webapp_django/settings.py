...
AUTH_USER_MODEL='app.CustomUser'
 #changes the built in user model to outrs
LOGIN_REDIRECT_URL = '/profiles/lel'
ADMIN_LOGIN=['abc@m.com']
...
EMAIL_HOST_USER='anushka.bhandari45@gmail.com'
EMAIL_HOST_PASSWORD='!arbitrary34FOX'
EMAIL_PORT=587
JQUERY_URL = True
MIDDLEWARE_CLASSES = [
